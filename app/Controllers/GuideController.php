<?php
namespace App\Controllers; use App\Repositories\Operations\GuideRepository; use App\Validators\BayerDataValidator;
class GuideController {private GuideRepository $r;public function __construct(){$this->r=new GuideRepository();}public function index(): void
    {
