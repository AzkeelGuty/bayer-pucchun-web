...
('Administrador','admin@local.test','$2y$12$blEEcZ5u.doRxHW5tlWO/ebUALjhHRs09y5TibYbD7N5W3v73X3Fu',1);
INSERT IGNORE INTO usuario_rol(usuario_id,rol_id)
SELECT u.id,r.id FROM usuarios u,roles r WHERE u.email='admin@local.test' AND r.nombre='ADMIN';
